...
var aidi_baseline_assessment_trials = {
  ...
  choices: ["<p style ='font-size:2vw; color: black; position: fixed; left: 38vw; bottom: 1.3vh;'><b>AI</b></p>", "<p style ='font-size: 2vw; color: black; position: fixed; right: 41vw; bottom: 1.3vh'><b>Human</b></p>"],
  button_html: (choice) => {
