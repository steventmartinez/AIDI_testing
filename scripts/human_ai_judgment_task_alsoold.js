...
var aidi_baseline_assessment_confidence = {
  ...
  stimulus: "<p><div style ='line-height: 1.25; padding-bottom: 3vh; font-size:2.5vw;'>How confident were you in accurately distinguishing the human- and AI-generated rental listings?</div></p>",
  require_movement: true,
  labels: ['Not all confident', 'Extremely confident'],
  slider_width: 700,
  };
...
var aidi_intervention1_training_exemplars = {
    timeline: [
        {
          data: {
            trial_id: "aidi_intervention1_training_exemplars_listing_preview",
            stage: "intervention_one",
            listing_type: function () {
              return `${jsPsych.evaluateTimelineVariable('listing_type')}`
            },
        ...
        },
        {
          ...
          stimulus: () => {
            return `<img src="study_design_images/airbnb_scheme_interface.png" <div style= "position:fixed; width: 59vw; height: 84vh; left: 21.5vw; top: 0vh;"></img>` +
              ...
              // `<p><div style ='font-size: 2vw; font-family: Arial; text-align: center; width: 51vw; height: 8vh; position: fixed; left: 25vw; bottom: 4vh; line-height: 1.5em; border: .3vw transparent; padding: .5vh'>This next rental listing is <b>${jsPsych.evaluateTimelineVariable('listing_type')}-generated</b></p>`
          },
